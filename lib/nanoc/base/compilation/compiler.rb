...
module Nanoc
  ...
  class Compiler
    ...
    def dependency_tracker
      dt = Nanoc::DependencyTracker.new(@site.environment, @site.items + @site.layouts)
      dt.compiler = self
      dt
    end
